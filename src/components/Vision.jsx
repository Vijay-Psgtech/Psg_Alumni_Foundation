...
const Vision = () => (
  <>
    <style>{`
      ...
      .mission-list{margin-top:20px;padding-left:20px;}
      .mission-list li{margin-bottom:12px;font-family:'Playfair Display',serif;font-size:clamp(18px,2.4vw,24px);color:rgba(232,238,252,.82);line-height:1.6;}
      ...
      <div className="vision-inner">
        ...
        <motion.div initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} transition={{duration:.75}} viewport={{once:true}}>
          <div className="vision-eyebrow">
            <div className="vline"/>Vision<div className="vline" style={{background:"linear-gradient(90deg,rgba(201,168,76,.65),transparent)"}}/>
          </div>
        </motion.div>
        ...
        <motion.div className="vision-card" initial={{opacity:0,y:38}} whileInView={{opacity:1,y:0}} transition={{duration:.9,delay:.2}} viewport={{once:true}}>
          ...
          <p className="vision-text">
            To strive to be the <strong>major support for PSG College of Technology & Polytechnic College mission</strong> of delivering <strong>world-class education and an exceptional learning environment</strong>.
          </p>
        ...
        {/* Mission */}
        <motion.div initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} transition={{duration:.75,delay:.2}} viewport={{once:true}}>
          <div className="vision-eyebrow">
            <div className="vline"/>Mission<div className="vline" style={{background:"linear-gradient(90deg,rgba(201,168,76,.65),transparent)"}}/>
          </div>
        </motion.div>

        <motion.div className="vision-card" initial={{opacity:0,y:38}} whileInView={{opacity:1,y:0}} transition={{duration:.9,delay:.3}} viewport={{once:true}}>
          ...
          <div className="vision-divider"/>
          <div className="vision-footer">Mission Statement</div>
        </motion.div>
